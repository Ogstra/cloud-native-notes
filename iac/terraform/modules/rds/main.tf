...
resource "aws_ssm_parameter" "db_url" {
  ...
  type  = "SecureString"
  value = "postgresql://postgres:${var.db_password}@${aws_db_instance.main.endpoint}/postgres?schema=public&sslmode=verify-full&sslrootcert=/app/certs/rds-combined-ca-bundle.pem"
